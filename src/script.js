...
let S = {
    ...
    posisions: {
        ...
        // "1": [4, 14, 15, 25], "2": [5, 6, 14, 15],
        // "3": [5, 15, 16, 26], "4": [15, 16, 24, 25]
    }
};
    ...
    for(let i = 0; i < row.length-1; i++){
        ...
        if(
            ...
            if(score === 150){
                ...
                level = 2;
                document.getElementById("score").innerHTML = "Level:" + level + " Score:" + score;
                play = setInterval(moveDown, 500)
            }else if(score === 300) {
                clearInterval(play);
                level = 3;
                document.getElementById("score").innerHTML = "Level:" + level + " Score:" + score;
                play = setInterval(moveDown, 250)
            }
        }
    }
}
...
function startNewGame(){
    score = 0;
    clearInterval(play);
    play = setInterval(moveDown, 1000);
    speed = 1000;
    level = 1;
    document.getElementById("score").innerHTML = "Level:" + level + " Score:" + score;
...
let play = setInterval(moveDown, 800);